...
<Tabs groupId="home">
  ...
  <TabItem value="scss" label="src/pages/home/style.scss">
    ```scss
    h1 {
      color: green;
    }
...
### Step 4: Add `<script>` and `<link>` tags into HTML
...
> :::tip
> Use Webpack aliases to avoid relative paths like `../../scripts/main.js`:
...
The template variables defined in the `data` option are available in a template w/o any prefix.
...
### Step 6: Move JS output filename
...
### Step 7: Move CSS output filename
